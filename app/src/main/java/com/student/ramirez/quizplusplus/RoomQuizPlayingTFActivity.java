...
public class RoomQuizPlayingTFActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timerRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (!dataSnapshot.exists()){
                    Toast.makeText(RoomQuizPlayingTFActivity.this, "Timer not found", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        btnEndQuiz.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        timer.cancel();
                        Intent intent = new Intent(RoomQuizPlayingTFActivity.this, RoomActivity.class);
                        // Room
    ...
    public void getAllQuestion(){
        db.child("Questions").addListenerForSingleValueEvent(
                new ValueEventListener() {
                    ...
                    @Override
                    public void onCancelled(DatabaseError databaseError) {
                        Toast.makeText(RoomQuizPlayingTFActivity.this, "Something went wrong!", Toast.LENGTH_SHORT).show();
                    }
                }
        );
    }
