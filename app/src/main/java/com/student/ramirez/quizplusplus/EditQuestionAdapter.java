...
public class EditQuestionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public EditQuestionAdapter(List<Question> questionList, QuestionAdapterListener questionAdapterListener) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        switch (question.getType()){
            ...
            case TRUEFALSE_TYPE:
                ...
                // Default Values
                ((TrueFalseViewHolder) holder).etQuestion.setText(questionList.get(holder.getAdapterPosition()).getQuestion());
                ...
                if (questionList.get(holder.getAdapterPosition()).getAnswer().isEmpty()){
            ...
            case MULTIPLECHOICE_TYPE:
                ...
                // Default Values
                ((MultipleChoiceViewHolder) holder).etQuestion.setText(questionList.get(holder.getAdapterPosition()).getQuestion());
                ((MultipleChoiceViewHolder) holder).etChoiceA.setText(questionList.get(holder.getAdapterPosition()).getChoiceA());
                ((MultipleChoiceViewHolder) holder).etChoiceB.setText(questionList.get(holder.getAdapterPosition()).getChoiceB());
                ((MultipleChoiceViewHolder) holder).etChoiceC.setText(questionList.get(holder.getAdapterPosition()).getChoiceC());
                ((MultipleChoiceViewHolder) holder).etChoiceD.setText(questionList.get(holder.getAdapterPosition()).getChoiceD());
                ((MultipleChoiceViewHolder) holder).rgAnswerChoices.setVisibility(View.VISIBLE);
                if (questionList.get(holder.getAdapterPosition()).getQuestion().isEmpty()){
    ...
    class TrueFalseViewHolder extends RecyclerView.ViewHolder {
        ...
        public TrueFalseViewHolder(View itemView) {
            ...
            rbTrue = (RadioButton) itemView.findViewById(R.id.rbAnswerTrue);
            rbFalse = (RadioButton) itemView.findViewById(R.id.rbAnswerFalse);
        }
    }
